...
section .bss			;AKA VARIABLES
	...
	xor ebx,ebx		;WE WILL USE THIS TO FIND THE SIZE OF THE NOT USEFUL PART OF THE IMAGE.
	xor edx,edx		;WE WILL USE THIS TO COUNT THE NUMBER OF LINES WE READ.
...
_cycleThroughImage:
	...
	mov ebx,2
	xor edx,edx		;WE NEED TO CLEAN EDX SINCE IT WILL STORE THE RESULT THERE.
...
_done:
	inc esi			;ESI ++, MOVES THROUGH IMAGE
	inc edi			;EDI ++, MOVES THROUGH MESSAGE
